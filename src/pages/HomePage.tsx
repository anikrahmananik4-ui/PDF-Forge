...
import { ArrowRight, ShieldCheck, Zap, Lock, Sparkles, Check, FileCheck, Layers, Users } from 'lucide-react';
    ...
    <div className="space-y-20 pb-20">
      ...
      <section className="relative overflow-hidden pt-12 pb-16 bg-gradient-to-b from-blue-50/80 via-white to-white dark:from-slate-900/50 dark:via-slate-900 dark:to-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            ...
            <button
              onClick={() => onSelectTool(PDF_TOOLS.find((t) => t.id === 'merge-pdf')!)}
              className="px-8 py-4 rounded-2xl bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-100 font-bold text-base border border-slate-200 dark:border-slate-700 shadow-md transition-all"
            >
              Merge PDFs Now
            </button>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 text-xs text-slate-500 dark:text-slate-400 pt-6">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>Instant Browser & Server Speed</span>
            </div>
            <div className="flex items-center gap-1.5">
      ...
      <section className="bg-slate-50 dark:bg-slate-800/40 py-16 border-y border-slate-200/80 dark:border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center space-y-3 max-w-2xl mx-auto">
            <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white">
              Why Professionals Choose PDFForge
            </h2>
            <p className="text-sm text-slate-500 dark:text-slate-400">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="space-y-4">
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 space-y-2">
            <h4 className="text-base font-bold text-slate-900 dark:text-white">Is PDFForge free to use?</h4>
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
          ...
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 space-y-2">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
              Absolute security is our top priority. All uploaded files are processed over TLS 256-bit encrypted channels and temporary files are automatically deleted after processing.
            </p>
          </div>
